			...
			<div class="container-fluid">
				...
				<div class="row">
					...
					<div class="col-md-8 col-xs-12">
						<div class="white-box">
							<form id="formProject" class="form-horizontal form-material">
								...
								<div class="form-group">
									...
									<div class="col-md-12">
										<input id="startDate" name="projectStartDate" type="date"
											value="${editProject.startDate.toLocalDate()}"
											class="form-control form-control-line">
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-md-12">
										<input name="projectEndDate" type="date"
											value="${editProject.endDate.toLocalDate()}"
											class="form-control form-control-line">
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-12">Trưởng dự án</label>
									<div class="col-sm-12">
										<select name="leader" class="form-control form-control-line">
											<c:if test="${loginedInfo.role.name == 'ADMIN'}">
												<c:forEach var="item" items="${leaders}">
													<c:choose>
														<c:when
															test="${editProject.leader.id eq item.id}">
															<option selected value="${item.id}">${item.firstName}
											...
											<c:if test="${loginedInfo.role.name == 'LEADER'}">
												<option value="${loginedInfo.id}">${loginedInfo.firstName}
													${loginedInfo.lastName}</option>
											</c:if>
										</select>
									</div>
								</div>
