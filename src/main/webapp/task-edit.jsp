	...
	<div id="wrapper">
		...
		<div id="page-wrapper">
			<div class="container-fluid">
				<div class="row bg-title">
					<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
						<h4 class="page-title">Cập nhật thông tin công việc</h4>
					</div>
				</div>
				<!-- /.row -->
				<!-- .row -->
				<div class="row">
					...
					<div class="col-md-8 col-xs-12">
						<div class="white-box">
							<form id="formTask" class="form-horizontal form-material">
			...
			<%-- 					<div class="form-group">
									...
									<div class="col-md-12">
										<select name="projectId"
											...
											<c:forEach var="item" items="${projects}">
												<c:choose>
													<c:when test="${editTask.project.name eq item.name}">
									...
									<div class="col-md-12">
										<select name="userId" class="form-control form-control-line">
											<c:forEach var="item" items="${users}">
												<c:choose>
													<c:when test="${editTask.user.lastName eq item.lastName}">
								...
								<div class="form-group">
									<div class="col-sm-12">
										<button id="btnTaskSubmit" type="submit"
